...
<head>
    ...
    <link rel="stylesheet" href="../../../static/jquery.treeview.css" type="text/css"/>

    <script type="text/javascript"> let ctx = '${ctx!''}'; </script>
    <script src="${ctx}/static/js/tree/jquery.min.js"></script>
    <script src="${ctx}/static/js/tree/jquery.treeview.js" type="text/javascript"></script>
    <script src="${ctx}/static/js/tree/index.js" type="text/javascript" charset="utf-8"></script>
